...
class TestMainFunction:
    ...
    def test_main_transfer_attack(
        ...
        mock_attack_lib.ProgressiveMultiPromptAttack.return_value = (
            mock_progressive_attack
        )
    ...
    @patch("advsecurenet.llm.GCG.experiments.main.get_workers")
    @patch("time.strftime")
    def test_main_individual_attack(
        self,
        mock_strftime,
        mock_get_workers,
        mock_get_goals,
    ...
    @patch("advsecurenet.llm.GCG.experiments.main.get_workers")
    @patch("time.strftime")
    def test_main_target_processing(
        self,
        mock_strftime,
        mock_get_workers,
        mock_get_goals,
