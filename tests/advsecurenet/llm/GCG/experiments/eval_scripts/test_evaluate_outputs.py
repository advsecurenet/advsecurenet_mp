...
class TestAdversarialEvaluator:
    ...
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoTokenizer.from_pretrained')
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoModelForCausalLM.from_pretrained')
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.get_conversation_template')
    ...
    def test_format_prompt(self):
        ...
        with patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoTokenizer.from_pretrained') as mock_tokenizer, \
             patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoModelForCausalLM.from_pretrained') as mock_model, \
             patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.get_conversation_template') as mock_get_template:
            ...
            mock_conv_template.append_message.assert_any_call("user", f"{goal} {suffix}")
    ...
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoModelForCausalLM.from_pretrained') 
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.get_conversation_template')
    def test_evaluate_suffix_success(self, mock_get_template, mock_model, mock_tokenizer):
        ...
        # Mock methods
        evaluator.format_prompt = MagicMock(side_effect=["baseline_prompt", "adversarial_prompt"])
        evaluator.generate_response = MagicMock(side_effect=[
    ...
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoModelForCausalLM.from_pretrained')
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.get_conversation_template')
    def test_evaluate_suffix_failure(self, mock_get_template, mock_model, mock_tokenizer):
    ...
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AutoModelForCausalLM.from_pretrained')
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.get_conversation_template')
    def test_refusal_pattern_detection(self, mock_get_template, mock_model, mock_tokenizer):
        ...
        evaluator.format_prompt = MagicMock(side_effect=lambda g, s="": "baseline_prompt" if not s else "adversarial_prompt")
        ...
        for response in refusal_responses:
            ...
            evaluator.generate_response = MagicMock(side_effect=[response, "compliance"])
            
            result = evaluator.evaluate_suffix("test goal", "test suffix")
            
            assert result['baseline_refused'] is True, f"Failed to detect refusal in: {response}"
            assert result['adversarial_refused'] is False
            assert result['success'] is True
...
class TestMainFunction:
    ...
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.argparse.ArgumentParser')
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.load_results_from_json')
    @patch('advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs.AdversarialEvaluator')
    @patch('builtins.open', new_callable=mock_open)
    @patch('json.dump')
    def test_main_function(self, mock_json_dump, mock_file, mock_evaluator_class, 
                          mock_load_results, mock_parser_class):
...
class TestIntegration:
    ...
    def test_refusal_patterns_comprehensive(self):
        ...
        from advsecurenet.llm.GCG.experiments.eval_scripts.evaluate_outputs import AdversarialEvaluator
