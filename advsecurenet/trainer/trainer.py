...
class Trainer:
    ...
    def __init__(self, config: TrainConfig):
        ...
        if (config.differential_privacy_config and config.differential_privacy_config.enable):
        ...
        optimizer = trainer_logic.get_optimizer(config.optimization_config.optimizer, model, config.training_process_config.learning_rate, **optimizer_kwargs)
